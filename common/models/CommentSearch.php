...
class CommentSearch extends Comment
{
    ...
    {
        return array_merge(parent::attributes(),['authorName','post.title']); // TODO: Change the autogenerated stub
    }
    ...
    public function rules()
    {
        return [
            ...
            [['content', 'email', 'url','authorName','post.title'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like','user.username',$this->getAttribute('authorName')]);
